    ...
    >
      <div className="space-y-4">
        <div className="flex items-start gap-3.5 p-4 rounded-appleLg bg-red-50/80 border border-red-100 text-red-900">
          ...
          <div>
            ...
            <p className="text-[12px] text-red-800/90 mt-1 leading-relaxed">
              ...
              <strong className="font-semibold text-red-950">"{producto.nombre}"</strong>.
        ...
        <p className="text-[12px] text-[#86868b] leading-relaxed">
          <span>Nota: Si el producto ya se encuentra relacionado a reservas confirmadas, el sistema no permitirá eliminarlo; en su lugar puedes cambiar su estado a </span>
